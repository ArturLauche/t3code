...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.cloudRuntimeList]: AuthOrchestrationReadScope,
  [WS_METHODS.cloudRuntimeSetCredential]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudRuntimeClearCredential]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudRuntimeTest]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudRuntimeCreateSandbox]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudRuntimeListSandboxes]: AuthOrchestrationReadScope,
  [WS_METHODS.cloudRuntimeSandboxAction]: AuthOrchestrationOperateScope,
  [WS_METHODS.cloudRuntimeExecute]: AuthOrchestrationOperateScope,
